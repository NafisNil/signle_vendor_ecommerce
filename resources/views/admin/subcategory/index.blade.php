              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @php
                    $subcategoryCount = App\Product::where('sub_category_id',$item->id)->count();
                @endphp
                  <tr>
                    <td>{{++$key}}</td>
                    <td>{{$item->name}}</td>
                    ...
                    <td>
                      <a href="{{route('subcategory.edit',[$item->id])}}"><button class="btn btn-outline-info btn-sm"><i class="fas fa-pen-square"></i></button></a>

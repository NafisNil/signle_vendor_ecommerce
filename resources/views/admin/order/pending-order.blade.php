              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                        @if ($item->status == 0)
                        <a href="{{route('order_approve',$item->id)}}" class="btn btn-sm btn-outline-secondary">
                            Pending
                          </a>
                        @else
                            Delivered
                    ...
                    <td>
                      <a href="{{route('customer.order.details',[$item->id])}}"><button class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i></button></a>

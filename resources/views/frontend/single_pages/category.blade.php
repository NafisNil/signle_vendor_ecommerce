...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li><a href="{{route('all_product')}}">{{$category_banner->name}}</a></li>
    </ul>
    <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 product-grid-item">
                    <div class="product-thumb transition">
                        ...
                        <div class="caption product-detail">
                            <h4 class="product-name"> <a href="{{route('details_product',$item->id)}}" title="women's clothing">Clothing</a> </h4>
        ...
        <div id="content" class="col-sm-9">
            <h2 class="category-title">{{$category_banner->name}}</h2>
